                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">                            
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Mold Protector</h4>
                                <div className="flex justify-center mb-4">
                                    <img src={image1} alt="Mold Protector" className="w-full h-[450px] rounded-lg" />
                                </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Card Press Machine</h4>
                                <div className="flex justify-center mb-4">
                                    <img src={image2} alt="Mold Protector" className="w-full h-[450px] rounded-lg" />
                                </div>
                                {/* <p className="text-md font-medium leading-5 h-auto md:h-48">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                            <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Painting Clamp Mask Tool</h4>
                                <div className="flex justify-center mb-4">
                                    <img src={image3} alt="Mold Protector" className="w-full h-[450px] rounded-lg" />
                                </div>
                                {/* <p className="text-md font-medium leading-5 h-auto md:h-48">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Circuit Audio/Lights Tester</h4>
                                <div className="flex justify-center mb-4">
                                    <img src={image4} alt="Mold Protector" className="w-full h-[450px] rounded-lg" />
                                </div>
                                {/* <p className="text-md font-medium leading-5 h-auto md:h-48">
