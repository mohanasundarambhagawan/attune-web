                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Research & Development</h2>
                                    <p className="text-md font-medium">
                                    We invest in pioneering solutions to stay ahead in the industry, transforming ideas into impactful results. By driving innovation and excellence, we continually advance our technology to meet the evolving needs of our clients.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Provide Custom Solutions</h2>
                                    <p className="text-md font-medium">
                                    We create custom solutions tailored to your unique needs, ensuring they align with your business goals. Our expertise and innovative approach deliver efficient and effective results, driving your success.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Devices & Software Production</h2>
                                    <p className="text-md font-medium">
                                    Specializing in high-quality devices and software tailored to unique needs, our solutions ensure seamless functionality and exceptional performance. Designed to enhance productivity and drive innovation, each product is built with precision and reliability in mind.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Deployment, Integration & Training</h2>
                                    <p className="text-md font-medium">
                                    Expert deployment, integration, and training services ensure a smooth transition to new technologies. Solutions are customized for seamless integration with existing systems, while comprehensive training empowers teams to maximize the benefits of new tools.
                                    </p>
                                </div>
                            </div>                    
                        </div>
