...
const NavBar = () => {
    ...
    return (
        <nav
            style={{ backgroundColor: '#f8f6f6' }} // Apply the custom color here
            className={`fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top ? 'shadow-lg' : ''}`}
        >
            <div className="flex flex-row justify-between items-center py-2">
                <div className="flex flex-row items-center pl-20">
                    <HashLink smooth to="/#hero" className="flex items-center">
                        ...
                        <h1 className="font-lato text-4xl text-gray-600">attune integrations</h1>
                    </HashLink>
                </div>
